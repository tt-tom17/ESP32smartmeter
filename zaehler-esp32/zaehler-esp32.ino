...
// ─── Webseiten (gemeinsames CSS unter /style.css) ─────────────────────────────
...
void setupWebOta() {
  web.on("/update", HTTP_GET, []() {
    web.send(200, "text/html",
      ...
      "<nav><a href=/>Start</a><a href=/strom>Strom</a><a href=/waerme>W&auml;rme</a>"
      "<a href=/update class=active>Update</a></nav>"
      "<div class=card><h2>Firmware-Update</h2>"
      "<p class=s>Arduino-IDE: <b>Sketch &rarr; Kompilierte Bin&auml;rdatei exportieren</b>, "
      "dann die <code>.ino.bin</code> hier w&auml;hlen.</p>"
...
void setup() {
  ...
  web.on("/style.css", [](){ web.send_P(200, "text/css",  CSS); });
